...
Rules: 3 insights, 2 recommendations, 1 anomaly max. Keep all text under 20 words each.`;
  ...
  // Extract JSON safely between first { and last }
  const start = clean.indexOf("{");
  const end = clean.lastIndexOf("}");
  ...
  try {
    ...
    return {
      summary: "Analysis complete. The dataset has been processed successfully.",
      insights: [
        { title: "Data Loaded", description: "Your dataset has been successfully loaded and analyzed.", type: "positive" },
        { title: "Explore Charts", description: "Use the Charts tab to visualize patterns in your data.", type: "info" }
      ],
      recommendations: [
        { title: "Check Charts Tab", action: "Navigate to the Charts section for visual analysis of your data." },
        { title: "Review Statistics", action: "Use the Statistics tab for detailed numeric summaries." },
        { title: "Export Data", action: "Use the Export button to download your processed dataset." }
      ],
      anomalies: [],
      topFindings: [
        "Dataset loaded and processed successfully",
        "Charts and statistics are available for exploration",
        "Use the Data Table tab to browse individual records"
      ]
    };
  }
}
